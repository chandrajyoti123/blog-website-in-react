...
export default function SecondBlogCard({blogimg,blogtitle,authorname,blogdate,userimg}) {
  return (
    <div className='blog-card-two'>
       <img src={ blogimg}  className='blogimg-two'/>
            <div className='blogbody'>
                <div className='blogcontent'>
                     <div className='blogheading bloheadingoftwo'>{blogtitle}</div>
            <div className='blogdetails'>
                         <div className='author'>
                            <img src={userimg} className='authorimg'/>
